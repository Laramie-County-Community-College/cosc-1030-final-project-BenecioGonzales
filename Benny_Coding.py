...
wins_3pt, thr_total_pts = simulate("three")
wins_2pt, two_total_pts = simulate("two")

print(f"The percentage chance of winning only going for threes is {wins_3pt/10000 * 100:.1f}% and the average points scored is {thr_total_pts/10000:.2f}")
print(f"The percentage chance of winning only going for twos is {wins_2pt/10000 * 100:.1f}% and the average points scored is {two_total_pts/10000:.2f}")